...
<head>
    ...
    <!-- Favicon - Coloca el archivo en: assets/img/favicon.ico -->
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body {
            ...
            background: linear-gradient(135deg, var(--primary-dark) 0%, var(--primary-black) 50%, var(--primary-gray) 100%);
        ...
        /* Logo de la universidad - Coloca en: assets/img/logo-uns.png */
        .logo-img {
            height: 55px;
            width: auto;
        }
        ...
        .logo-text span { font-size: 0.75rem; color: var(--gold-accent); font-weight: 500; }
        ...
        .nav-links a:hover { color: var(--accent-red-light); }
        ...
        .hero-title span {
            background: linear-gradient(135deg, var(--accent-red-light), var(--gold-accent));
        ...
        .stat-number { font-size: 2.5rem; font-weight: 800; color: var(--accent-red-light); }
        ...
        .section-subtitle { color: var(--accent-red-light); font-size: 0.9rem; font-weight: 600; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 0.5rem; }
        ...
        .service-card h3 { font-size: 1.3rem; margin-bottom: 1rem; font-weight: 600; }
        ...
        .info-content h2 { font-size: 2.5rem; font-weight: 700; margin-bottom: 1.5rem; }
        .info-content p { color: var(--text-muted); font-size: 1.1rem; margin-bottom: 1.5rem; }
        ...
        .info-visual h3 { font-size: 1.5rem; margin-bottom: 2rem; color: var(--accent-red-light); }
        ...
        .contact-text span { display: block; font-size: 0.85rem; color: var(--text-muted); }
        .contact-text strong { font-size: 1rem; }
        ...
        .footer-column h4 { font-size: 1rem; margin-bottom: 1.5rem; color: var(--accent-red-light); }
        .footer-column ul { list-style: none; }
        .footer-column li { margin-bottom: 0.75rem; }
        .footer-column a { color: var(--text-muted); text-decoration: none; font-size: 0.9rem; transition: color 0.3s; }
        .footer-column a:hover { color: var(--accent-red-light); }
...
<body>
    ...
    <header class="header">
        <div class="header-container">
            <div class="logo">
                <!-- Logo UNS - Coloca el archivo en: assets/img/logo-uns.png -->
                <img src="<?php echo BASE_URL; ?>assets/img/logo-uns.png" alt="Logo UNS" class="logo-img">
                <div class="logo-text">
        ...
        <div class="section-container">
            ...
            <div class="services-grid">
                <div class="service-card">
                    ...
                    <p>Asignación de un tutor académico que te acompañará durante toda tu carrera universitaria.</p>
                </div>
                <div class="service-card">
                    <div class="service-icon">💬</div>
                    <h3>Consejería Psicológica</h3>
                    <p>Servicio de apoyo emocional con profesionales capacitados para ayudarte.</p>
                </div>
                <div class="service-card">
                    <div class="service-icon">🎯</div>
                    <h3>Orientación Vocacional</h3>
                    <p>Ayuda para definir tu proyecto de vida profesional identificando tus fortalezas.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="footer-container">
            <div class="footer-grid">
                <div class="footer-brand">
                    <img src="<?php echo BASE_URL; ?>assets/img/logo-uns.png" alt="Logo UNS">
                    <div>
                        <h3>Sistema de Tutoría UNS</h3>
                        <p>Plataforma digital para la gestión integral del programa de tutoría universitaria.</p>
                    </div>
                </div>
